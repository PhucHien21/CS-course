...
namespace Assignment7_2
{
    class Program
    {
        ...
        {
            string filePathHotel = @"D:\CS\Assignment7\hotel.txt";
            string filePathRoom = @"D:\CS\Assignment7\room.txt";
            string filePathCustomer = @"D:\CS\Assignment7\customer.txt";
            ...
            Console.WriteLine(jsonSerializer.WriteToJSONFileHotel(hotel, filePathHotel));
            Console.WriteLine(jsonSerializer.WriteToJSONFileRoom(rooms, filePathRoom));
            Console.WriteLine(jsonSerializer.WriteToJSONFileCustomer(customers, filePathCustomer));
